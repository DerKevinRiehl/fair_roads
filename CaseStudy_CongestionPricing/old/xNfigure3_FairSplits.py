...
metric_vals_egal, metric_std = calculateFairnessMetric(tt_population, fairness_gini)
metric_vals_util, metric_std = calculateFairnessMetric(tt_population, np.sum)
metric_vals_hars, metric_std = calculateFairnessMetric(tt_population, np.nanmedian, "only once")
metric_vals_rawl, metric_std = calculateFairnessMetric(tt_population, np.nanmax, "only once")
